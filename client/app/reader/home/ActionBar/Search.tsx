    ...
    return (
         <div className="h-full flex items-center">
            <InputText
                ...
                inputBoxClassName="!p-1 !min-h-auto !max-h-auto !h-auto !bg-neutral-800/50 !rounded-l-md !rounded-r-none !border-neutral-700"
            ...
            <InputDropdown
                ...
                toggleClassName="box-content !min-h-[18px] !max-h-[18px] !h-[18px] p-1 pl-2 pr-1 !gap-x-2 !bg-neutral-800/50 !border-neutral-700 !border-l-0 !rounded-r-md !rounded-l-none shadow-sm"
