    ...
    return (
         <div className="h-full flex items-center">
            <InputDropdown
                ...
                toggleClassName="box-content !min-h-[18px] !max-h-[18px] !h-[18px] p-1 pl-2 pr-1 !gap-x-2 !bg-neutral-800/50 !border-neutral-700 !rounded-l-md !rounded-r-none shadow-sm"
                toggleLabelClassName="!text-xs !tracking-wide  whitespace-nowrap"
            />
            <button
                className="h-[28px] w-[28px] flex justify-center items-center -space-x-2 bg-neutral-800/50 border border-l-0 border-neutral-700 hover:bg-neutral-800/50 cursor-pointer rounded-r-md"
