...
export default function NavigationBar(props: NavigationBarProps) {
    ...
    return (
        <div className="p-2 flex justify-center gap-x-2 bg-neutral-900 border border-t-0 border-neutral-800 rounded-b-lg">
            <button className="h-[24px] aspect-square flex justify-center items-center bg-neutral-800 border border-neutral-700 rounded-md shadow">
                <ChevronsLeftIcon
                    size={14}
                    strokeWidth={2}
            ...
            <div className="flex items-center gap-x-1">
                <InputText
                    ...
                    inputBoxClassName="w-min !h-[24px] !max-h-[24px] !min-h-[24px] !px-0 !py-1 bg-neutral-800 border-neutral-700"
