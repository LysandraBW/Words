...
export default function Sort(props: SortProps) {
    return (
         <div className="h-full flex items-center">
            ...
            />
            <button
                className="h-[28px] w-[28px] flex justify-center items-center -space-x-2 bg-neutral-800 border border-l-0 border-neutral-700 hover:bg-neutral-800/50 cursor-pointer rounded-r-md"
